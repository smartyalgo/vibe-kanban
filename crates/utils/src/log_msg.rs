...
pub const EV_BRANCH_NAME: &str = "branch_name";
...
impl LogMsg {
    pub fn name(&self) -> &'static str {
        match self {
            ...
            LogMsg::BranchName(_) => EV_BRANCH_NAME,
    ...
    pub fn to_sse_event(&self) -> Event {
        match self {
            ...
            LogMsg::BranchName(s) => Event::default().event(EV_BRANCH_NAME).data(s.clone()),
    ...
    pub fn approx_bytes(&self) -> usize {
        ...
        match self {
            ...
            LogMsg::BranchName(s) => EV_BRANCH_NAME.len() + s.len() + OVERHEAD,
